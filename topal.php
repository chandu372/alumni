...
<div class="form-inline" style="background-color:#1B374C !important">
    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <div class="card bg-light " style="margin-top: 20px;height: 100vh;margin-left: 10%;margin-right: 10%">
        <div class="card-body text-center"  style="display:flex;justify-content: center;flex-direction: column;" >
        <h4 style="black">Coming Soon...</h4>
        </div>
        </div>
