...
<div class="form-inline" style="background-color:#1B374C !important">
    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <div class="card bg-light " style="margin-top: 20px;max-height: 80vh;margin-left: 10%;margin-right: 10%">
        <div class="card-body text-center"  >

        <img src="images/hu2.jpg" style="width: 60%">
<h6 style="color: black;margin-top: 30px">“VNIT HR Club” will be the 2nd such group after the “VNIT Entrepreneur Club” towards this initiative to bring in successful and budding VNIT Human resource Professionals across all domains and verticals.</h6>
