...
<div class="form-inline" style="background-color:#1B374C !important">
    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <div class="card bg-light " style="margin-top: 20px;max-height: 140vh;margin-left: 10%;margin-right: 10%">
        <div class="card-body text-center">
        <img src="images/mag.png" style="width: 100%">


        <div class="card bg-light" style="margin-top: 30px">
        <div class="card-body text-center" >
        <a href="#"><img src="images/mag2.jpg" style="width:20%" ></a>
        <h5 style="color: black ;margin-top: 10px">Alumni Magzine 2017</h5>
        </div>
        </div>

        <div class="card bg-light" style="margin-top: 15px">
        <div class="card-body text-center">
       <a href="#"> <img src="images/mag.jpg" style="width:20%"></a>
        <h5 style="color: black;margin-top: 10px">Alumni Magzine 2018</h5>
        </div>
        </div>
