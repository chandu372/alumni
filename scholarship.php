...
<div class="form-inline" style="background-color:#1B374C !important">
    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <div class="card bg-light " style="margin-top: 20px;min-height: 50vh;margin-left: 10%;margin-right: 10%">
        <div class="card-body text-center">
        
         <div class="card bg-light " style="margin-top: 20px;">
        <div class="card-body text-center">
        <h1 style="color: black;font-size: 35px">Alumni  Scholarships</h1>
        </div>
        </div>
        
         <div class="card bg-light " style="margin-top: 20px;margin-left: 10%;margin-right: 10%">
        <div class="card-body text-center">
        <p style="color: black">The 2020 Visvesvaraya national insitute of technology Alumni Scholarship  rewards the merit graduates of the University's undergraduate and postgraduate programs  who have demonstrated their passion for learning and loyalty to the University by commencing in a second, third or fourth degree at the University.</p>
        </div>
        </div>
         
         <h4 style="color: blue;margin-top: 30px">Stay Tuned For Further Updates...</h4>
        </div>
        </div>
