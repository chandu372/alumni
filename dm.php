...
<div class="form-inline" style="background-color:#1B374C !important">
    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <div class="card bg-light " style="margin-top: 20px;max-height: 100vh;margin-left: 10%;margin-right: 10%">
        <div class="card-body text-center"  >

        <img src="images/dm2.jpg"style=" width: 60%">
          <h6 style="color: black;margin-top: 30px">“VNIT Digital Marketing Club” will be the 3rd such group after the “VNIT HR club” & “VNIT Entrepreneur Club” towards this initiative to bring in successful and budding VNIT Digital Marketing Professionals across all domains and verticals. The club will be closely aligned with startup and business school to have synergy for the required inputs/experience sharing and feedback system for all the stakeholders.</h6>
          <br>
          <h6 style="color: black">  A key focus is to enable alumni interested in digital marketing eco-system to connect, interact, get involved and share opportunities globally.</h6>


           <form class="form-inline" action="/action_page.php" style="margin-top: 30px">
        <input class="form-control mr-sm-2" type="text" placeholder="Search People" style="width: 30%;margin-left: 30%;">
        &nbsp;
