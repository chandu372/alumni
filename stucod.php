...
<div class="form-inline" style="background-color:#1B374C !important">
    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <div class="card bg-light " style="margin-top: 20px;height: 80vh;margin-left: 10%;margin-right: 10%">
        <div class="card-body text-center"  >
        <img src="images/sc.png" style ="width:80%;height:40%">

        <div class="card bg-light " style="margin-top: 20px;margin-left: 10%;margin-right: 10%">
        <div class="card-body " >
          <h4 style="color:blue">Under progress...</h4>
          <img src="images/sreg.png" style="width: 60%;" >
          <h6 style="color: black;margin-top: 25px">For more details: contact-<a href="tel:+91-9096399077" style="color: brown;font-size: 14px">VNITAA</a></h6>
        </div>
        </div>
