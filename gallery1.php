...
<div class="form-inline" style="background-color:#1B374C !important">
    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <div class="card-body text-center">
          <h1 style="color: black;font-size: 35px">Gallery</h1>
        </div>
      </div>
    ...
    <div class="col-md-6" style="text-align: center;">
      <div class="card bg-light " style="margin-top: 20px;">
        <div class="card-body text-center">
      <img src="images/vnit1.jpg" style="width: 100%">
    </div>
  </div>
    </div>
    <div class="col-md-6" style="text-align: center;">
      <div class="card bg-light " style="margin-top: 20px;">
        <div class="card-body text-center">
      <img src="images/vnit2.jpg" style="width: 100%;">
    </div>
  </div>
    </div>
  </div>
  <div class="row">
   <div class="col-md-6" style="text-align: center;">
    <div class="card bg-light " style="margin-top: 20px;">
        <div class="card-body text-center">
    <img src="images/vnit6.jpg" style="width: 100%;">
  </div>
</div>
  </div>
  <div class="col-md-6" style="text-align: center;">
    <div class="card bg-light " style="margin-top: 20px;">
        <div class="card-body text-center">
    <img src="images/nat.jpg" style="width: 100%;">
  </div>
</div>
   </div>
  </div>
 <div class="row">
  <div class="col-md-6" style="text-align: center;">
    <div class="card bg-light " style="margin-top: 20px;">
        <div class="card-body text-center">
   <img src="images/vnit5.jpg" style="width: 100% ;">
 </div>
</div>
 </div>
 <div class="col-md-6" style="text-align: center;">
  <div class="card bg-light " style="margin-top: 20px;">
        <div class="card-body text-center">
   <img src="images/vnit7.jpg" style="width: 100%;">
 </div>
</div>
  </div>
 </div>
