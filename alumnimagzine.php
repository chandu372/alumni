...
<div class="form-inline" style="background-color:#1B374C !important">
 ...
 <img src="images/mag.png" style="padding-top: 30px;max-width: 100%; text-align: center;">
</div>
 <br>
 
   <h1 style="color: white; padding-top: 20px;text-align: center; ">Alumni Magzine 2019</h1>
   <div style="text-align: center";> 
   <a href="#"><img src="images/vnit.png" style="width: 300px;max-width: 100%; padding-top: 10px;"></a>
</div>


   <h1 style="color: white;padding-top: 20px ;text-align: center;">Alumni Magzine 2018</h1>
    <div style="text-align: center"; >
   <a href="#"><img src="images/mag.jpg" style="width: 300px;max-width: 100%; padding-top: 10px;text-align: center;"></a>
</div>
<div class="row">
  ...
  <div class="col-md-6" style="display: inline-block;text-align: center;margin-top: 30px; ">
