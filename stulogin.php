...
<div class="form-inline" style="background-color:#1B374C !important">
  ...
  <div >
    <h3 style="color: green;padding-top: 100px;text-align: center;">Student Login Form</h3>
  <form action="student-login-val.php" class="was-validated" method="POST">
    <div class="form-group container" >

      <label for="uname" style="color: white">E-mail id:</label>
      <input type="email" class="form-control"  id="uname" placeholder="Enter E-mail id" name="e-mail" required>
  ...
  <div class="row">
   <div class="col-md-6" style="display: block;text-align: center;margin-top: 20px;margin-bottom: 20px ">
  ...
  <div class="col-md-6" style="display: inline-block;text-align: center;margin-top: 20px;margin-bottom: 20px ">
