...
<div class="form-inline" style="background-color:#1B374C !important">
    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <div class="card bg-light " style="margin-top: 20px;max-height: 160vh;margin-left: 10%;margin-right: 10%">
        <div class="card-body text-center">
        
        <div class="card bg-light " style="margin-top: 20px;margin-left: 10%;margin-right: 10%">
        <div class="card-body text-center">
        <img src="images/lor.png" width="100%">
        </div>
        </div>
        
        <h5 style="color: grey;margin-top: 25px;margin-bottom: 25px">Please request Letter of Recommendation from Alumnus profile,Few samples are given below:</h5>
        ...
        <div class="row">
          <div class="col-md-6">
             ...
             <div class="card-body text-center">
            <img src="images/lor1.jpg" style="width: 100%">
          </div>
        </div>
          </div>
           <div class="col-md-6">
          <div class="card bg-light " style="margin-top: 20px;">
            ...
            <img src="images/lor2.png"  style="width: 100%">
          </div>
        </div>
          </div>
        </div>
