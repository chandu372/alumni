...
<div class="form-inline" style="background-color:#1B374C !important">
    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <div class="card bg-light " style="margin-top: 20px;min-height: 170vh;margin-left: 10%;margin-right: 10%">
        <div class="card-body text-center"  >
        <img src="images/sig.png" style ="width:80%;height:25%">

        <div class="card bg-light " style="margin-top: 20px;margin-left: 10%;margin-right: 10%">
        <div class="card-body "  >
         <a href="startup.php"> <img src="images/startup.jpg" style="width: 40%;" ></a>
          <h3 style="color: black;margin-top: 5px;font-size: 26px">Entrepreneur</h3>
          <h6 style="color: black">Isn't someone who owns a business. It's someone who makes things happen.</h6>
        </div>
        </div>

        <div class="card bg-light " style="margin-top: 20px;margin-left: 10%;margin-right: 10%">
        <div class="card-body "  >
          <a href="dm.php"> <img src="images/dm.jpg" style="width: 40%;" ></a>
            <h3 style="color: black;margin-top: 5px">Digital marketing</h3>
          <h6 style="color: black">Is an expression of personality itself in the social media eco-system; as essential as your presence in the business eco-system.</h6>
        </div>
        </div>

        <div class="card bg-light " style="margin-top: 20px;margin-left: 10%;margin-right: 10%">
        <div class="card-body "  >
           <a href="hr.php"><img src="images/hr.jpeg" style="width: 40%;" ></a>
            <h3 style="color: black;margin-top: 5px">Human resources</h3>
          <h6 style="color: black">If your actions inspire others to dream more,learn more, do more and become more, you are a Leader.</h6>
        </div>
        </div>
          <h6 style="color: blue;margin-top: 20px">For more details : contact-<a href="tel:+91-9096399077" style="color: blue;font-size: 14px">VNITAA</a></h6>
        </div>
        </div>
