...
<div class="form-inline" style="background-color:#1B374C !important">
    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <div class="card bg-light " style="margin-top: 20px;min-height: 100vh;margin-left: 5%;margin-right: 5%">
        <div class="card-body text-center">


        <div class="card bg-light " style="margin-top: 20px;margin-left: 5%;margin-right: 5%">
        <div class="card-body text-center">
        <img src="images/log.png" style="width: 60%">
        </div>
        </div>

        <h1 style="color: black;margin-top: 20px">Welcome To VNITAA</h1>
        <div class="row" style="margin-top: 20px">
          <div class="col-md-4" style="text-align: left;margin-top: 20px">
            <img src="images/al.jpeg" style="width: 100%;">
          </div>

          <div class="col-md-8" style="margin-top: 100px;text-align: left;" >
            <h6 style="color: black">Welcome to the Official Alumni Network of Visvesvaraya National Institute of Technology Alumni Association (VNITAA) Nagpur - A interactive networking platform for the alumni of VNIT to connect with each other - thus forging and reinforcing relationships formed in their student years at VNIT.This website aims to offer a quick overview of the activities of the VNITAA, the role that it plays in forging networking and collaborations with alumni, and above all in aiding and supporting numerous activities at VNIT.
           Signup to create your profile, search and connect to all the Alumni of VNIT.</h6>
         </div>
        </div>


          
        <a href="https://vnitalumni.com"> <button type="button" class="btn btn-warning" style="margin-top: 40px; color: white" >Know More</button></a>
