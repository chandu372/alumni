...
<div class="form-inline" style="background-color:#1B374C !important">
    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <img src="images/su.jpg" style="width: 60%">
        <h6 style="color: black;margin-top: 30px">“VNIT Entrepreneurs Club” is an initiative to bring in successful and budding VNIT entrepreneurs across all domains and verticals. The club will be closely aligned with the LPU’s Startup School initiative which is currently focusing to mold the next generation of entrepreneurs from VNIT.</h6> 
<br>
<h6 style="color: black">
A key focus is to enable alumni interested in start-ups to connect, interact, get involved and share opportunities globally.</h6>
        <form class="form-inline" action="/action_page.php" style="margin-top: 30px">
        <input class="form-control mr-sm-2" type="text" placeholder="Search Entrepreneur" style="width: 30%;margin-left: 30%;">
        &nbsp;
