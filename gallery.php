...
<div class="form-inline" style="background-color:#1B374C !important">
  ...
  <div class="row">
    <div class="col-md-6" style="text-align: center;">
      <img src="images/vnit1.jpg" style="margin-top: 15px;max-width: 100%">
    </div>
    <div class="col-md-6" style="text-align: center;">
      <img src="images/vnit2.jpg" style="height:326px ;max-width: 100%;margin-top: 15px">
    </div>
  </div>
  <div class="row">
   <div class="col-md-6" style="text-align: center;">
    <img src="images/vnit6.jpg" style="margin-top: 15px;max-width: 100%;">
  </div>
  <div class="col-md-6" style="text-align: center;">
    <img src="images/vnit3.jpg" style="height: 299px;max-width: 100%;margin-top: 15px">
   </div>
  </div>
 <div class="row">
  <div class="col-md-6" style="text-align: center;">
   <img src="images/vnit5.jpg" style="margin-top: 15px;max-width: 100%;height: 336px ;">
 </div>
 <div class="col-md-6" style="text-align: center;">
   <img src="images/vnit7.jpg" style="height:336px ;max-width: 100%;margin-top: 15px">
  </div>
 </div>
