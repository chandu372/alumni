    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <div style="text-align: center;">
            ...
            <h3 style="color: black ">Online UPI mode</h3>
            <br>

            <p style="color: black">Scan the QR code using your UPI apps</p>
            <div class="card bg-light " style="margin-top: 20px;margin-left: 30%;margin-right: 30%">
        <div class="card-body text-center"   >
            <img src="images/qr.png" style="max-width: 100%">
          </div>
        </div>
            <br>
            <a href="https://payments.cashfree.com/order/#2f3wziczdehw8okns37l" ><h3 style="margin-top: 15px">Other payment methods</h3></a>
        </div>
        </div>
        </div>
