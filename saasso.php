...
<div class="form-inline" style="background-color:#1B374C !important">
    ...
    <span class="nav-item dropdown">
      ...
      <div class=  "dropdown-menu" style="background-color:#1B374C ">
        ...
        <div class="card bg-light " style="margin-top: 20px;min-height: 85vh;margin-left: 10%;margin-right: 10%">
        <div class="card-body text-center">


          <div class="card bg-light " style="margin-top: 20px;margin-left: 20%;margin-right: 20%">
        <div class="card-body text-center">
        <img src="images/saa.png" style="width:80%;height: 30%">
        </div>
        </div>
           
           <p style="color: black;margin-top: 30px;margin-right: 10%;margin-left: 10%;text-align: left">The Student Alumni Association (SAA) promotes strong student and alumni relations through programming and events that bring the two groups together. Hear from alumni at career conferences, receive mentoring from an alum working in your field, or attend an alumni dinner to network and learn more about a specific discipline.</p>
           
           <p style="color: black;margin-right: 10%;margin-left: 10%;text-align: left">One of the main purposes of alumni associations is to support a network of former graduates who will, in turn, help to raise the profile of the university. Just like most other university student organizations, alumni associations aim to bring together like-minded individuals.</p>

           <a href="saa.php"> <button type="button" class="btn btn-warning" style="margin-top: 15px; color: white" >Register</button></a>
